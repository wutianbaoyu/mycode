...
public class denglu implements MouseListener{
...
public void init(){
		...
		im = new ImageIcon("images/11.png");
		...
		login_button = new JButton(img_login);
		jb=new JButton("重置");  
...
public void mousePressed(MouseEvent e) {
	...
	//如果点击的是登录按钮
		...
		if(ck.checkUser(jtext_acount.getText(), jtext_password.getText())){

			new zhujiemian().jf.setVisible(true);
			jf.setVisible(false);
