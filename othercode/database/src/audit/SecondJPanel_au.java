...
public class SecondJPanel_au {		
	...
	public static JComboBox JComboBox2 = new JComboBox(new OrganizationCl().getJob());
	...
	public void init(){
		...
		JComboBox2.setFont(new Font( "Î¢ÈíÑÅºÚ",Font.BOLD,12));
