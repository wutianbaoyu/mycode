...
public class NeuralNet {
	...
	public NeuralNet initNet(int numberOfInputNeurons, //用伪随机实数初始化listofweightIn和listOfWeightOut
		...
		for (int i = 0; i < numberOfHiddenLayers; i++) {//获取隐藏层
	...
	public NeuralNet trainNet(NeuralNet n){
		...
		case ADALINE:
			...
			return trainedNet;
		case BACKPROPAGATION://BP网络算法，有监督学习网络
			Backpropagation b = new Backpropagation();
			trainedNet = b.train(n);
			return trainedNet;
		case KOHONEN://自组织竞争型神经网络的一种，无监督学习网络
